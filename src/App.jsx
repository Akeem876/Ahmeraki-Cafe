...
const MobileMenu = ({ isOpen, toggleMenu }) => (
  ...
  >
    <svg
      className="w-6 h-6"
      fill="none"
      stroke="#4A4A4A" // Changed to a dark gray color
      viewBox="0 0 24 24"
...
const Nav = ({ isOpen, setIsOpen }) => {
  const navLinks = [
    ...
    { name: "Product Collection", path: "/products" },
    { name: "Menu", path: "/menu" },
    { name: "Join Our Family", path: "/join" },
  ];

  // Close menu when a link is clicked
  const handleLinkClick = () => {
    if (window.innerWidth < 768) { // Only close if we're on mobile
      setIsOpen(false);
    }
  };
  ...
  return (
    <>
      ...
      {/* Mobile Navigation - Updated with better visibility */}
      <nav
        className={`md:hidden w-full ${
          isOpen ? "block" : "hidden"
        } border-t border-gray-200 bg-green-800 shadow-lg`}
      >
        <div className="flex flex-col items-center">
          {navLinks.map((item) => (
            <Link
              key={item.name}
              to={item.path}
              className="text-white hover:text-amber-300 uppercase text-sm tracking-wider font-medium py-4 border-b border-green-700 w-full text-center"
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col w-screen m-0 p-0 overflow-x-hidden bg-gray-50">
      ...
      <header className="bg-gray-50">
        ...
        <Nav isOpen={mobileMenuOpen} setIsOpen={setMobileMenuOpen} />
      </header>
...
// // // Create page components for your routes
// // // const HomePage = () => {
// //   // You can move your existing JSX content here
// //   const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
// //   const toggleMobileMenu = () => setMobileMenuOpen(!mobileMenuOpen);
// //   // ... copy your gallery images, feature items, etc. from App
// //   const galleryImages = [
// //     "/Breakfastclub-cup-latte.jpg",
// //     "/Two-customers-breakfast.jpg",
// //     "/Barista-pouring-milk.jpg",
...
// //       {/* CTA Section */}
// //       <section className="relative py-16 md:py-20 bg-cover bg-center"
// //         style={{ backgroundImage: "url('/Two-customers-breakfast.jpg')" }}>
// //         <CTA/>
// //       </section>
// //     </>
// //   );
...
// // const StoryPage = () => <div className="py-20 px-4"><h1 className="text-3xl text-center">Our Story</h1></div>;
// // const ProductsPage = () => <div className="py-20 px-4"><h1 className="text-3xl text-center">Product Collection</h1></div>;
// // const MenuPage = () => <div className="py-20 px-4"><h1 className="text-3xl text-center">Menu</h1></div>;
// // const JoinPage = () => <div className="py-20 px-4"><h1 className="text-3xl text-center">Join Our Family</h1></div>;

// // // Keep your existing components (Logo, MobileMenu, etc.)
// // const Logo = () => (
// //   <Link to="/">
// //     <div className="flex items-center justify-center py-4 w-full">
// //       <span className="text-green-800 text-2xl md:text-3xl font-semibold tracking-wider">
...
// // const Nav = ({ isOpen }) => {
// //   // Update your Nav component to use Link instead of a tags
// //   const navLinks = [
// //     { name: "Home", path: "/" },
// //     { name: "Our Story", path: "/story" },
// //     { name: "Product Collection", path: "/products" },
...
// // // Keep all other component definitions
